...
public class PlayerService {
	...
	public Statistics insertPlayerWithStatistics(String playerFirstName, String playerLastName, String team,
			Position position, int year, int weekNumber, int passingCompletions, int passingAttempts, int passingYards,
			int passingTouchdowns, int passingInterceptions, int rushingAttempts, int rushingYards,
		...
		validateStats(team, year, weekNumber, passingCompletions, passingAttempts, passingYards, passingTouchdowns,
				passingInterceptions, rushingAttempts, rushingYards, rushingTouchdowns, receivingTargets,
		...
		Statistics statistics = new Statistics(player, year, weekNumber, team, passingCompletions, passingAttempts,
				passingYards, passingTouchdowns, passingInterceptions, rushingAttempts, rushingYards, rushingTouchdowns,
	...
	public void validateStats(String team, int year, int weekNumber, int passingCompletions, int passingAttempts,
		...
		if (passingCompletions < 0 || passingAttempts < 0 || passingTouchdowns < 0 || passingInterceptions < 0
			...
			throw new StatisticsException(
					"Completion, Attempt, Touchdown, Interception, and Targets" + " statistics cannot be negative");
		}
		validateTeam(team);
