...
public class StatisticsControllerTest {
	...
	public void testGetSeasonWeek() throws Exception {
		...
		mockMvc.perform(get("/api/statistics/{season}/{weekNumber}", season, weekNumber)).andExpect(status().isOk())
...
//        String statsJson = stats.toString();
		...
		mockMvc.perform(post("/api/statistics/").content(stats.toJson()).contentType(MediaType.APPLICATION_JSON))
